...
OhdsiRTools::checkUsagePackage("hiv_test_study")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/hiv_test_study.pdf")
shell("R CMD Rd2pdf ./ --output=extras/hiv_test_study.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("hiv_test_study")
