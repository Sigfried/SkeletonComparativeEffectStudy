...
# age breakdown of male +50 cohort, instructions here:
# https://ohdsi.github.io/FeatureExtraction/articles/UsingFeatureExtraction.html#creating-a-table-1



# Insert cohort definitions from ATLAS into package -----------------------
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
  baseUrl = Sys.getenv("WebAPIBaseUrl"),
  insertTableSql = TRUE,
  insertCohortCreationR = TRUE,
  generateStats = FALSE,
  packageName = "hiv_test_study")
